...
<div class="container">
  ...
  <br /><br />
    ...
    <tr>
            ...
            <tr>
                <td>التاريخ</td>
                <td>{{ Form::text('OEvent_date', $id ? $other['OEvent_date'] : null, ['class' => 'form-control', 'id' => 'datePicker', 'autocomplete' => 'off', 'placeholder' => 'حدد التاريخ']) }}
</td>
            </tr>
            <tr>
                <td>الوقت</td>
                <td>{{ Form::text('OEvent_time', $id ? $other['OEvent_time'] : null, ['class' => 'form-control', 'id' => 'timePicker', 'autocomplete' => 'off', 'placeholder' => 'حدد الوقت']) }}</td>
            </tr>
            <tr>
                <td>الموقع</td>
            ...
            <tr>
                ...
                <td>{{ Form::text('OEvent_link', $id ? $other['OEvent_link'] : null, ['class' => 'form-control', 'autocomplete' => 'off']) }}</td>
            </tr>
        </tbody>
    </table>  
