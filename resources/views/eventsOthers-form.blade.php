...
<body>
  ...
  <div class="container">
    ...
    <div class="table-responsive text-nowrap">
      <table class="table table-bordered">
        <tbody>
          <tr>
            ...
            <td>{{ Form::text('OEvent_name', $id ? $other['OEvent_name'] : null, ['class' => 'form-control',
              'autocomplete' => 'off']) }}</td>
          </tr>
          <tr>
            <td>التاريخ</td>
            <td>{{ Form::text('OEvent_date', $id ? $other['OEvent_date'] : null, ['class' => 'form-control', 'id' =>
              'datePicker', 'autocomplete' => 'off', 'placeholder' => 'حدد التاريخ']) }}
            </td>
          </tr>
          <tr>
            <td>الوقت</td>
            <td>{{ Form::text('OEvent_time', $id ? $other['OEvent_time'] : null, ['class' => 'form-control', 'id' =>
              'timePicker', 'autocomplete' => 'off', 'placeholder' => 'حدد الوقت']) }}</td>
          </tr>
          <tr>
            <td>الموقع</td>
            <td>{{ Form::text('OEvent_location', $id ? $other['OEvent_location'] : null, ['class' => 'form-control',
              'autocomplete' => 'off']) }}</td>
          </tr>
          <tr>
            <td>مقدم الفعالية</td>
            <td>{{ Form::text('OEvent_presenter', $id ? $other['OEvent_presenter'] : null, ['class' => 'form-control',
              'autocomplete' => 'off']) }}</td>
          </tr>
          <tr>
            <td>رابط نموذج التسجيل </td>
            <td>{{ Form::text('OEvent_link', $id ? $other['OEvent_link'] : null, ['class' => 'form-control',
              'autocomplete' => 'off']) }}</td>
          </tr>
        </tbody>
      </table>
      ...
      <a href="{{ route('other.index') }}" class="btn btn-danger btn-sm btn-rounded">رجوع</a>
