    ...
    <div class="table-responsive text-nowrap">
      <table class="table table-bordered">
        <tbody>
          <tr>
            <td>عنوان المؤتمر</td>
            <td>{{ Form::text('conference_name', $id ? $conference['conference_name'] : null, ['class' =>
              'form-control', 'autocomplete' => 'off']) }}</td>
          </tr>
          <tr>
            <td>التاريخ</td>
            <td>{{ Form::text('conference_date', $id ? $conference['conference_date'] : null, ['class' =>
              'form-control', 'id' => 'datePicker', 'autocomplete' => 'off', 'placeholder' => 'حدد التاريخ']) }}
            </td>
          </tr>
          <tr>
            <td>الوقت</td>
            <td>{{ Form::text('conference_time', $id ? $conference['conference_time'] : null, ['class' =>
              'form-control', 'id' => 'timePicker', 'autocomplete' => 'off', 'placeholder' => '24:00']) }}</td>
          </tr>
          <tr>
            <td>الموقع</td>
            <td>{{ Form::text('conference_location', $id ? $conference['conference_location'] : null, ['class' =>
              'form-control', 'autocomplete' => 'off']) }}</td>
          </tr>
          <tr>
            <td>رابط نموذج التسجيل </td>
            <td>{{ Form::text('conference_link', $id ? $conference['conference_link'] : null, ['class' =>
              'form-control', 'autocomplete' => 'off']) }}</td>
          </tr>
        </tbody>
      </table>
      ...
      <a href="{{ route('conferences.index') }}" class=" btn btn-danger btn-sm btn-rouneded">رجوع</a>
