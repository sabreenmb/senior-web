      ...
      <table class="table table-bordered">
        <tbody>
          <tr>
            ...
            <td>{{ Form::text('workshop_name', $id ? $workshop['workshop_name'] : null, ['class' => 'form-control',
              'autocomplete' => 'off']) }}</td>
          </tr>
          <tr>
            <td>التاريخ</td>
          ...
          <tr>
            <td>الوقت</td>
            <td>{{ Form::text('workshop_time', $id ? $workshop['workshop_time'] : null, ['class' => 'form-control', 'id'
              => 'timePicker', 'autocomplete' => 'off', 'placeholder' => '24:00']) }}</td>
          </tr>
          <tr>
            <td>الموقع</td>
            <td>{{ Form::text('workshop_location', $id ? $workshop['workshop_location'] : null, ['class' =>
              'form-control', 'autocomplete' => 'off']) }}</td>
          </tr>
          <tr>
            <td>مقدم الورشة</td>
            <td>{{ Form::text('workshop_presenter', $id ? $workshop['workshop_presenter'] : null, ['class' =>
              'form-control', 'autocomplete' => 'off']) }}</td>
          </tr>
          <tr>
            <td>رابط نموذج التسجيل </td>
            <td>{{ Form::text('workshop_link', $id ? $workshop['workshop_link'] : null, ['class' => 'form-control',
              'autocomplete' => 'off']) }}</td>
          </tr>
        </tbody>
      </table>
